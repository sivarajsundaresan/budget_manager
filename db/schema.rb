...
ActiveRecord::Schema.define(version: 20190419072347) do
  ...
  create_table "budgets", force: :cascade do |t|
    ...
    t.index ["spend_id"], name: "index_budgets_on_spend_id", using: :btree
    t.index ["spend_type"], name: "index_budgets_on_spend_type", using: :btree
  ...
  create_table "commands", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["post_id"], name: "index_commands_on_post_id", using: :btree
  end
